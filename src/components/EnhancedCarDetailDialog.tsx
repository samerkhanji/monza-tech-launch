...
export const EnhancedCarDetailDialog: React.FC<EnhancedCarDetailDialogProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        {/* YELLOW SCROLLBAR CSS */}
        <style>{`
          .force-yellow-scrollbar {
            overflow-y: scroll !important;
            scrollbar-width: thick !important;
            scrollbar-color: #FFD700 #000000 !important;
          }
          
          .force-yellow-scrollbar::-webkit-scrollbar {
          ...
          .force-yellow-scrollbar::-webkit-scrollbar-track {
            background-color: #000000 !important;
            border-radius: 0px !important;
          }
          
          .force-yellow-scrollbar::-webkit-scrollbar-thumb {
          ...
          .force-yellow-scrollbar::-webkit-scrollbar-thumb:hover {
        ...
        <div className="p-4 border-b bg-white flex-shrink-0">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold flex items-center gap-2">
              ...
              Car Details - {car.model} ({car.vinNumber})
            </h2>
        ...
        {/* SCROLLABLE CONTENT WITH YELLOW SCROLLBAR */}
        <div 
          className="force-yellow-scrollbar"
          style={{
            flex: 1,
