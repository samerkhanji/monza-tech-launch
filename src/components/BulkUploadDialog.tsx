...
import { Camera, Upload, Plus, Trash2, Check, X } from 'lucide-react';
...
const BulkUploadDialog: React.FC<BulkUploadDialogProps> = ({
  ...
  const [globalSettings, setGlobalSettings] = useState({
    ...
    shippingCompany: '',
    trackingCode: '',
    category: 'voyah' as 'voyah' | 'normal_engine'
  });
  ...
  const processReceipt = async (imageDataUrl: string) => {
    try {
      ...
      // Pre-populate global settings from receipt
      ...
      toast({
        ...
        description: `Found ${data.items.length} items. Please review and edit as needed.`,
      });
    } catch (error) {
      toast({
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Bulk Upload Parts from Receipt
            ...
            <div className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Take a photo or upload an image of your parts receipt. MonzaBot will extract the information automatically.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <CameraSection
            ...
            <div className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    These settings will apply to all items in this order
                  </CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center justify-between">
                    Parts List ({processedItems.length} items)
                      ...
                      {processedItems.map((item, index) => (
                        <TableRow key={index}>
                          ...
                          <TableCell>
                            <Select 
                              value={item.category} 
                              onValueChange={(value: 'voyah' | 'normal_engine') => updateItem(index, 'category', value)}
                            >
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="normal_engine">Normal Engine</SelectItem>
                              </SelectContent>
                            </Select>
                          </TableCell>
                          <TableCell>
          ...
          {step === 'review' && (
            <div className="flex gap-2">
              ...
              >
                ...
                Save {processedItems.length} Parts
              </Button>
            </div>
          )}
        </DialogFooter>
