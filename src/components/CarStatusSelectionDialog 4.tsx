      ...
      const updateData = {
        ...
        ...(selectedStatus === 'reserved' ? {
          ...
          deliveryChecklist: {
            ...
            pdiCompleted: (car as any).pdiCompleted || false,
                ...
                {clientInfo.clientName && (
                  <div className="text-sm text-blue-600">
                    ...
                    {selectedStatus === 'reserved' && clientInfo.reservationDate && (
                      <p><span className="font-medium">Reservation:</span> {clientInfo.reservationDate.toLocaleString()}</p>
                    )}
                    {selectedStatus === 'sold' && clientInfo.saleDate && (
                      <p><span className="font-medium">Sale:</span> {clientInfo.saleDate.toLocaleString()}</p>
                    )}
                  </div>
                )}
                {!clientInfo.clientName && (
...
export default CarStatusSelectionDialog; 