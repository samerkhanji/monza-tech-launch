...
export const CarStatusSelectionDialog: React.FC<CarStatusSelectionDialogProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className="max-w-2xl max-h-[70vh] bg-white border border-gray-300 shadow-xl car-status-dialog flex flex-col" 
        style={{ 
          zIndex: 50001,
          height: '70vh'
        }}
      >
        ...
        >
          <div className="space-y-6 pt-4 pb-20" style={{ minHeight: '80vh', paddingRight: '10px' }}>
          {/* Current Status */}
