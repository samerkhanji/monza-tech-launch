...
WHERE id IN ('car-photos', 'documents', 'pdi-files', 'repair-photos', 'signatures');
...
-- File size limit: 50MB (52428800 bytes) for most buckets
-- Signatures: 10MB (10485760 bytes) 
-- All buckets allow common image formats
-- Documents bucket also allows PDFs and text files
-- Car photos and repair photos are public (for easy display)
