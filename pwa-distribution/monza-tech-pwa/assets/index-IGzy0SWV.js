import{u as y,r as n,t as c,j as e,bK as b,e as l,f as d,g as m,b0 as k,i as g,L as v,I as j,d as N,aG as w}from"./index-CrIDvSVN.js";const E=()=>{const[u]=y(),[s,p]=n.useState(""),[a,h]=n.useState(!1);n.useEffect(()=>{const t=u.get("track");t&&(p(t),a&&window.YQV5&&setTimeout(()=>{o()},500))},[u,a]),n.useEffect(()=>{const t=document.createElement("style");t.innerHTML=`
