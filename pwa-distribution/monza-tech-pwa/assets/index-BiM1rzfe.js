import{u as y,r as n,t as c,j as e,bK as b,b as l,c as d,d as m,b0 as k,f as g,L as v,I as j,a as N,aG as w}from"./index-BjC2zLSq.js";const E=()=>{const[u]=y(),[s,p]=n.useState(""),[a,h]=n.useState(!1);n.useEffect(()=>{const t=u.get("track");t&&(p(t),a&&window.YQV5&&setTimeout(()=>{o()},500))},[u,a]),n.useEffect(()=>{const t=document.createElement("style");t.innerHTML=`
