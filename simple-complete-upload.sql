-- Simple Complete Stock Data Upload for Monza TECH
-- This script adds all missing vehicles with the current database structure
...
-- Now insert the missing vehicles (these are NOT duplicates of existing ones)
...
('Mrs. Suhair Khanji', 'LDP95H965SE900262', 'REEV', 'GREY', 'Free', 2025, 
 '1907-12-30', '2030-12-30', '2033-12-30', '2030-08-21', 'Sold', 'Sold', NOW(), NOW()),
